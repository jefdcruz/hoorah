...
import com.hoorah.rest.repository.BeerRepository;
...
public class BeerCommandLineRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		repository.findAll().forEach(System.out::println);// TODO Auto-generated method stub
	}
